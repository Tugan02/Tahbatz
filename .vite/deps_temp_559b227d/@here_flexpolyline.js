...
// node_modules/@here/flexpolyline/index.js
var require_flexpolyline = __commonJS({
  "node_modules/@here/flexpolyline/index.js"(exports, module) {
    ...
    function decodeUnsignedValues(encoded) {
      ...
      encoded.split("").forEach((char) => {
        ...
        result |= (value & Num(31)) << shift;
        if ((value & Num(32)) === Num(0)) {
          resList.push(result);
          result = Num(0);
          shift = Num(0);
        } else {
    ...
    function encodeUnsignedNumber(val) {
      ...
      let numVal = Num(val);
      while (numVal > 31) {
        const pos = numVal & Num(31) | Num(32);
...
export default require_flexpolyline();
//# sourceMappingURL=@here_flexpolyline.js.map
